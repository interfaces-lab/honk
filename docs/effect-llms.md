<!--
Copied verbatim from https://github.com/Effect-TS/effect-smol (LLMS.md), via t3code's
vendored copy (.repos/effect-smol/LLMS.md), June 2026. This is the idiomatic-Effect
guide t3code instructs its coding agents to read before writing Effect code.

Note: relative links like ./ai-docs/src/... refer to files in the effect-smol repo:
https://github.com/Effect-TS/effect-smol/tree/main/ai-docs/src
honk is on the same Effect 4 beta line, so these idioms apply directly.
-->
