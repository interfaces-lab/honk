...
// Pierre's default diff colors are derived through color-mix(). Cursor ships
// concrete line, intraline, and gutter values, so the unsafe layer consumes
// Honk's generated variables directly and leaves no library-side color math.
...
:host {
  ...
  --diffs-bg-separator: var(--honk-color-layer-01);
  --diffs-fg: var(--honk-color-text-primary);
  --diffs-fg-number: var(--honk-color-text-faint);
...
[data-line-type="change-addition"][data-column-number],
[data-line-type="change-addition"][data-gutter-buffer] {
  color: var(--honk-color-diff-gutter-addition);
}

[data-line-type="change-deletion"][data-column-number],
[data-line-type="change-deletion"][data-gutter-buffer] {
  color: var(--honk-color-diff-gutter-deletion);
}
`;
