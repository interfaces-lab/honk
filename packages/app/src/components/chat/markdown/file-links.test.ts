...
describe("resolveMarkdownFileLinkTarget", () => {
  ...
  it("formats tooltip display paths relative to the cwd when possible", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "file:///C:/Users/mike/dev-stuff/multi/packages/app/src/session-logic.ts#L501",
        "C:/Users/mike/dev-stuff/multi",
      ),
    ).toMatchObject({
      displayPath: "multi/packages/app/src/session-logic.ts:501",
    });
  });
  ...
  it("formats tooltip display paths relative to the cwd for slash-prefixed windows paths", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "/C:/Users/mike/dev-stuff/multi/packages/app/src/components/chat/messages-timeline.virtualization.browser.tsx",
        "C:/Users/mike/dev-stuff/multi",
      ),
    ).toMatchObject({
      displayPath:
        "multi/packages/app/src/components/chat/messages-timeline.virtualization.browser.tsx",
    });
  });
