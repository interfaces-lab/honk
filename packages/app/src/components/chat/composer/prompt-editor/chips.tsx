...
const styles = stylex.create({
  chip: {
    alignItems: "center",
    borderRadius: "var(--honk-radius-base)",
    display: "inline-flex",
    ...
    marginLeft: "var(--honk-composer-chip-offset-x)",
    marginTop: "var(--honk-composer-chip-offset-y)",
    minWidth: 0,
    paddingBlock: "var(--honk-composer-chip-padding-block)",
    paddingLeft: "var(--honk-composer-chip-padding-inline)",
    paddingRight: "var(--honk-composer-chip-padding-inline)",
    userSelect: "none",
