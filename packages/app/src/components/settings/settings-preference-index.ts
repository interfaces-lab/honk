...
export const SETTINGS_PREFERENCE_ENTRIES = [
  ...
  {
    id: "agents.account.claude-api-key",
    section: "agents",
    panelLabel: "Agents",
    sectionTitle: "Accounts",
    title: "Claude API Key",
    description: "Anthropic API key credential for Claude agents.",
    searchTerms: ["claude-api-key", "anthropic", "api key", "claude"],
  },
  {
    id: "agents.account.claude-oauth",
    section: "agents",
    panelLabel: "Agents",
    sectionTitle: "Accounts",
    title: "Claude OAuth",
    description: "OAuth sign-in for Claude agents.",
    searchTerms: ["claude-oauth", "anthropic", "oauth", "claude", "sign in"],
  },
  {
    ...
    sectionTitle: "Accounts",
    title: "Codex OAuth",
    description: "OAuth sign-in for Codex agents.",
    searchTerms: ["codex-oauth", "openai", "oauth", "codex", "sign in"],
  },
  {
    id: "agents.account.codex-api-key",
    section: "agents",
    panelLabel: "Agents",
    sectionTitle: "Accounts",
    title: "Codex API Key",
    description: "OpenAI API key credential for Codex agents.",
