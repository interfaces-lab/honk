    ...
    <Button
      ...
      className={cn(
        variant === "chrome"
          ...
          : "multi-agent-sidebar-cell agent-sidebar-cell font-multi flex h-auto min-h-0 w-full select-none gap-3 items-center justify-start rounded-multi-control border border-transparent bg-transparent px-0 py-0 text-left text-body font-normal shadow-none outline-none ring-offset-0 transition-[color] duration-100 ease-out before:hidden focus-visible:ring-offset-0 motion-reduce:transition-none",
        className,
      )}
      {...rest}
    />
