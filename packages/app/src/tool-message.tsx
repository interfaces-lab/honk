...
import { Pill, ToolCallLine, WorkGroup, type ToolCallState } from "@honk/ui";
import { colorVars, conversationVars, radiusVars } from "@honk/ui/tokens.stylex";
    ...
    <div {...stylex.props(styles.attachments)}>
      {attachments.map((attachment) => {
        ...
        return attachment.mime.startsWith("image/") ? (
          ...
          <a key={attachment.id} href={attachment.url} {...stylex.props(styles.attachmentAnchor)}>
            <Pill size="inline" tone="surface" isMono>
              {name}
            </Pill>
          </a>
        );
