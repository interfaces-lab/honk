...
export default function NewTaskRoute(): React.ReactElement {
  ...
  if (serverKey === null) return <Redirect href="/(tabs)/home" />;
  ...
  if (client === null) {
    return (
      <Page>
        <Stack.Title>New session</Stack.Title>
        <ConnectionUnavailableState
          fallbackDetail={`Honk will let you start a session when ${server.descriptor.label} is reachable.`}
