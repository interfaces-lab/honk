...
const reloadWindow = Effect.gen(function* () {
  const desktopWindow = yield* DesktopWindow.DesktopWindow;
  yield* desktopWindow.reload;
}).pipe(Effect.withSpan("desktop.menu.reloadWindow"));
...
const make = Effect.gen(function* () {
  ...
  const configure = Effect.gen(function* () {
    ...
    const reloadClick = () => {
      runMenuEffect("reload-window", reloadWindow);
    };
    const resetZoomClick = () => {
      runMenuEffect("reset-font-sizes", dispatchMenuAction("reset-font-sizes"));
    };
    const zoomInClick = () => {
      runMenuEffect("increase-font-sizes", dispatchMenuAction("increase-font-sizes"));
    };
    const zoomOutClick = () => {
      runMenuEffect("decrease-font-sizes", dispatchMenuAction("decrease-font-sizes"));
    };
