...
const groups = [
  ...
  [
    "control",
    {
      ...
      "--honk-control-menu-pad": px(honkTheme.web.control.menuPad),
  ...
  [
    "font",
    {
      ...
      "--honk-leading-body-lg": px(honkTheme.web.font.leadingBodyLg),
      ...
      "--honk-letter-spacing-caption": px(honkTheme.web.font.letterSpacingCaption),
      "--honk-letter-spacing-detail": px(honkTheme.web.font.letterSpacingDetail),
      "--honk-letter-spacing-body": px(honkTheme.web.font.letterSpacingBody),
      "--honk-letter-spacing-body-lg": px(honkTheme.web.font.letterSpacingBodyLg),
