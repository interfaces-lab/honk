...
const sx = stylex.create({
  ...
  popup: {
    ...
    // oxlint-disable-next-line honk/design-no-raw-values -- 3px is the tooltip's compact vertical text inset; no spacing token owns this value
    paddingBlock: "3px",
