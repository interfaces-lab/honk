...
const TRACK_WIDTH_MD = "30px";
const TRACK_HEIGHT_MD = "18px";
const TRACK_WIDTH_SM = "26px";
const TRACK_HEIGHT_SM = "16px";
const THUMB_SIZE_MD = "14px";
const THUMB_SIZE_SM = "12px";
...
const sx = stylex.create({
  ...
  trackMd: { width: TRACK_WIDTH_MD, height: TRACK_HEIGHT_MD },
  trackSm: { width: TRACK_WIDTH_SM, height: TRACK_HEIGHT_SM },
