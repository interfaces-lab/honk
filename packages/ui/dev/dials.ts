...
const prosePanel: PanelSpec = {
  ...
  config: {
    ...
    size: [14, 12, 18, 0.5],
    leading: [1.6, 1.2, 2, 0.05],
    flowGap: [8, 0, 24, 1],
    tightGap: [4, 0, 12, 1],
    sectionGap: [16, 8, 40, 1],
  },
  bindings: {
    measure: { cssVar: cssVarName(proseVars["--honk-prose-measure"]) },
    size: { cssVar: cssVarName(proseVars["--honk-prose-size"]) },
    leading: { cssVar: cssVarName(proseVars["--honk-prose-leading"]), format: unitless },
    flowGap: { cssVar: cssVarName(proseVars["--honk-prose-flow-gap"]) },
    tightGap: { cssVar: cssVarName(proseVars["--honk-prose-tight-gap"]) },
