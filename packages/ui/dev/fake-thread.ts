...
const STEP_SCRIPT: readonly StepSeed[] = [
  {
    ...
    runningVerb: "Reading",
    settledVerb: "Read",
    detail: "src/tabs.tsx · 687 lines",
    settledState: "done",
  },
  {
    tool: "search",
    runningVerb: "Grepping",
    settledVerb: "Grepped",
    detail: "useSyncExternalStore · 14 hits",
    settledState: "done",
  },
  {
    tool: "edit",
  ...
  },
  {
    ...
    runningVerb: "Running",
    settledVerb: "Command",
    detail: "pnpm run lint:design · exit 1",
    settledState: "failed",
  },
  {
    tool: "read",
    runningVerb: "Reading",
    settledVerb: "Read",
    detail: "docs/adr/0025-react-doctrine.md",
    settledState: "done",
  },
  {
    tool: "edit",
  ...
  },
  {
    ...
    runningVerb: "Running",
    settledVerb: "Ran",
    detail: "pnpm run lint:design · 0 violations",
    settledState: "done",
  },
];
...
// The onStatus callback per run, so the tick loop can report each transition.
  ...
  const timer = setInterval(() => {
    ...
    if (tick <= WORKING_TICKS) {
      ...
      next = {
        ...current,
        status: "working",
        rows: seed === undefined ? settled : Object.freeze([...settled, runningRow(tick, seed)]),
      };
