...
Honk is a research and learning project focused on building the best possible experience for agentic tooling.
...
Honk is an independent project. It builds on MIT-licensed work from [T3 Code](https://github.com/pingdotgg/t3code) and [OpenCode](https://github.com/anomalyco/opencode); their copyright notices are retained in [LICENSE](./LICENSE). Its interface takes inspiration from Cursor.
...
| `spec/`     | Project-owned engineering conventions and architecture specifications    |
...
When investigating Cursor behavior, follow the
[Cursor code handbook](./docs/cursor-parity-handbook.md) to recover product
rules from the installed app before changing Honk.
